...
from workout.models import WorkoutPackage, WorkoutDetail, Routine, WeekRoutine
...
class HealthCoach(models.Model):
    '''
        1주일치 기록들을 모아서 패키지의 완성을 체크하는 곳
    '''

    client = models.ForeignKey('운동을 시작한 User', settings.AUTH_MODEL_USER, related_name='health_coaches')
    ...
    week_record = models.ForeignKey('Package 기록', WeekRecord, blank=True, null=True)